...
function Planet({ title, description, image, github, website, orbiting, position }: Props) {
  const texture = useLoader(TextureLoader, `../../../public/assets/planet${image}.jpg`);
  const githubIcon = useLoader(TextureLoader, "../../../public/assets/github.svg");
  const linkIcon = useLoader(TextureLoader, "../../../public/assets/link.svg");
  const projectImage = useLoader(TextureLoader, `../../../public/assets/project${image}.png`);
